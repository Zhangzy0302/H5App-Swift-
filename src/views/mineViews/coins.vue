...
.coin-box-header {
  ...
  color: rgba(0, 0, 0, 1);
  padding-left: calc(100vw * 39 / 375);
}
...
.coin-item {
  ...
  box-sizing: border-box;
  border: calc(100vw * 1 / 375) solid rgba(221, 123, 15, 1);
}
...
.coin-radio {
  ...
  border: calc(100vw * 1 / 375) solid rgba(44, 44, 44, 1);
}
...
.coin-radio-selected {
  ...
  border: calc(100vw * 4 / 375) solid rgba(255, 255, 255, 1);
}
</style>