<template>
  <div class="agreement-page">
    ...
    <div class="agreement-content">
      ...
      <h1>Sien User Agreement</h1>

      <p class="update-time">Last updated: 2026</p>

      <p>
        Welcome to <strong>Sien</strong>. Please read this User Agreement carefully before using the
        Sien application and services. By accessing or using the service, you agree to be bound
        by this agreement.
      </p>
      ...
      <p>
        By creating an account or using Sien, you confirm that you have read,
      ...
      <p>
        Sien provides online social interaction services including but not limited to
        messaging, video interaction, profile creation, and virtual item purchases.
      </p>

      <p>
        Sien reserves the right to modify, suspend, or discontinue any part of the
      ...
      <p>
        You may be required to create an account to access certain features of Sien.
      ...
      <p>
        Sien may offer virtual items such as diamonds or coins which can be used
      ...
      <p>
        Sien reserves the right to suspend or terminate your account if you violate
      ...
      <p>
        The Sien service is provided on an "as is" and "as available" basis without
      ...
      <p>
        Sien may update this agreement from time to time. Continued use of the
